...
#Shivam Shah            (github: shivam1023)
#Feras Al-Hamadani      (github: feras96)
#Jordan Clark           (github: jordanc44) 
#Saxon Zerbino          (github: lordofsax)
...
def handle_mousedown(x,y,button):
  ...
  if button == "left":
    ...
    if score == 24:
      ...
      image(275, 450, "http://i.imgur.com/eSSXfA8.png")
